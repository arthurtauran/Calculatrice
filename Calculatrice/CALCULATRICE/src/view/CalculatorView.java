...
public class CalculatorView {
    ...
    private JButton moinNegatifButton;
    ...
    public void addActionListener(ActionListener listener) {
        ...
        moinNegatifButton.addActionListener(listener);
